...
const EnrollmentHistory = () => {
  ...
  function createData(name, calories, fat, carbs, protein, icon) {
    return {
      name, calories, fat, carbs, protein, icon
    };
  }
          ...
          <Table sx={{ borderTop: '1px solid #E0E0E0' }} aria-label="simple table">
            <TableHead>
              <TableRow>
                ...
                <TableCell align="left">Data enrollment</TableCell>
                <TableCell align="left">Current action</TableCell>
                <TableCell align="left">Current status</TableCell>
                <TableCell align="left">Next execution on</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {rows.map((row) => (
                ...
                >
                  ...
                  }}><AccessTimeIcon style={{ fontSize: '5px', padding: '9px' }} /></span>&nbsp;{row.fat}</TableCell>
                  <TableCell align="left"><span style={{
