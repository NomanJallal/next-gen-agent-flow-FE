  ...
  return (
    <Box sx={{ flexGrow: 1, margin: '-24px', backgroundColor: '#F2F4F7' }}>
      <Grid container spacing={0}>
        <Grid item xs={5}>
          <Card style={{
            width: '150px', marginTop: '20px', borderRadius: '25px', margin: '20px 10px'
          }}>
            <Grid
              container
              direction="row"
        ...
        <Grid item xs={7}>
          <Card
            sx={{ padding: '10px 40px', border: 'none', borderRadius: '0px' }}
          >
            <p
              style={{
                fontSize: '24px',
          ...
          <div
            style={{ width: '100%', height: '1px', backgroundColor: '#E0E0E0' }}
          ></div>
          <Card
            sx={{ borderRadius: '0px', border: 'none', padding: '20px 40px' }}
          >
            <Grid
              container
              direction="row"
